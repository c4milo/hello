...
func RegisterHelloHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("GET", pattern_Hello_SayHi_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Hello_SayHi_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_Hello_Counts_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Hello_Counts_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("DELETE", pattern_Hello_DeleteCounts_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Hello_DeleteCounts_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
